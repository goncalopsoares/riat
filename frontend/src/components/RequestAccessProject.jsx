...
const RequestAccessProject = ({ showRequestAccess, setShowRequestAccess, existingProjectCode, setExistingProjectCode, newUserRole, setNewUserRole, newUserFunction, setNewUserFunction, handleRequestAccess }) => {
        ...
        <div id="assessment-alert" className="modal">
            <div className="modal-content" style={{ width: '32rem', textAlign:'start' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <a onClick={() => setShowRequestAccess(false)} className="close-btn margin-auto" aria-label="Close alert">Close</a>
                </div>
            </div>
        </div>
    );
